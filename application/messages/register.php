...
return array(
    'username' => array(
        ...
        'toomany_digits' => 'Username cannot contain more then 4 digits',
        'invalid_name'   => 'Username contains restricted keywords'
    ),
    ...
    'email' => array(
        ...
        'invalid'       => 'Invalid email address and/or password',
    ),
    'birthdate' => array(
    ...
    'tos' => array(
        'not_empty'    => 'You must agree to the TOS to register.',
    ),
);
/*
return array(
