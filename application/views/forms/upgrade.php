...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#feature-list').find('tr').find('td:eq(1)').css('background-color', '#F7F5F5');
        $('#feature-list').find('tr').find('td:eq(2)').css('background-color', '#F9F8E4');
        $('#feature-list').find('tr').find('td:eq(3)').css('background-color', '#FBF3E9');
        $('#feature-list tr:hidden').find('td:eq(1)').css('background-color', '#E4E9ED');
        
        $('#feature-list input:radio').click(function() {
            switch($(this).val()) {
                case '3':
                case '4':
                case '5':
                    $('#feature-list tr[id^="Promo-"]').hide();
                    $('#Promo-' + $(this).val()).show();
                    break;
            }
        });
    ...
    <div class="data">
        <table cellspacing="1" cellpadding="0" id="feature-list">
            ...
            <tr>
                ...
                <td class="table-data">25 Per Day</td>
            ...
            <!--tr>
                ...
                <td class="table-data">5 Per Day</td>
            ...
            <tr>
                <td></td>
                <td class="table-data" style="background-color: #fff;"><?= Form::radio('plan', '3', ( ! empty($post['plan']) AND $post['plan'] == '3') ? TRUE : FALSE, array('class' => ( ! empty($errors['plan'])) ? 'err' : '')) ?> <span class="price">$24.95<small>a month</small></span></td>
                <td class="table-data"><?= Form::radio('plan', '4', ( ! empty($post['plan']) AND $post['plan'] == '4') ? TRUE : FALSE, array('class' => ( ! empty($errors['plan'])) ? 'err' : '')) ?> <span class="price">$32.95<small>a month</small></span></td>
                <td class="table-data"><?= Form::radio('plan', '5', ( ! empty($post['plan']) AND $post['plan'] == '5') ? TRUE : FALSE, array('class' => ( ! empty($errors['plan'])) ? 'err' : '')) ?> <span class="price">$39.95<small>a month</small></span></td>
            </tr>
            <tr id="Promo-3" class="hide">
                <td></td>
                <td colspan="3" id="promo">
                    <?= Form::radio('plan', '6', ( ! empty($post['plan']) AND $post['plan'] == '6') ? TRUE : FALSE) ?>
                    <span class="price">Get 6 Months at $16.50<sub>*</sub><small>a month</small></span><br />
                    
                    <small>* billed as one installment of $99.00</small>
                </td>
            </tr>
            <tr id="Promo-4" class="hide">
                <td></td>
                <td colspan="3" id="promo">
                    <?= Form::radio('plan', '7', ( ! empty($post['plan']) AND $post['plan'] == '7') ? TRUE : FALSE) ?>
                    <span class="price">Get 6 Months at $24.95<sub>*</sub><small>a month</small></span> <?= HTML::image('assets/img/upgrade/goldmedal.png', array('alt' => 'Get it for the price of Silver!')); ?><br />
                    
                    <small>* billed as one installment of $149.70</small>
                </td>
            </tr>
            <tr id="Promo-5" class="hide">
                <td></td>
                <td colspan="3" id="promo">
                    <?= Form::radio('plan', '8', ( ! empty($post['plan']) AND $post['plan'] == '8') ? TRUE : FALSE) ?>
                    <span class="price">Get 6 Months at $32.95<sub>*</sub><small>a month</small></span> <?= HTML::image('assets/img/upgrade/platinummedal.png', array('alt' => 'Get it for the price of Gold!')); ?><br />
                    
                    <small>* billed as one installment of $197.70</small>
                </td>
            </tr>
        </table>
    </div>
