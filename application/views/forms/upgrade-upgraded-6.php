    ...
    <div class="data">
        <table cellspacing="1" cellpadding="0" id="feature-list">
            ...
            <tr>
                ...
                <td class="table-data"><?= (Core::$user->membership->type == 'Silver') ? '150' : '100'; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td></td>
                <td class="table-data"><?= Form::radio('plan', '7', ( ! empty($post['plan']) AND $post['plan'] == '7') ? TRUE : FALSE, array('class' => ( ! empty($errors['plan'])) ? 'err' : '')) ?> <span class="price">$<?= (Core::$user->membership->type == 'Silver') ? '40.00' : ''; ?><small>one time fee</small></span></td>
                <td class="table-data"><?= Form::radio('plan', '8', ( ! empty($post['plan']) AND $post['plan'] == '8') ? TRUE : FALSE, array('class' => ( ! empty($errors['plan'])) ? 'err' : '')) ?> <span class="price">$<?= (Core::$user->membership->type == 'Silver') ? '75.00' : '40.00'; ?><small>one time fee</small></span></td>
            </tr>
         </table><br />
         
         <div class="submit-area">
        By pressing submit you are agreeing to upgrade your membership level. You are agreeing to have your card billed a one time upgrade fee listed above. Your membership term and anniversary date will remain the same as your initial membership upgrade. Additionally, by upgrading your membership you agree and understand that your membership will renew at the rates of your newly selected membership. 
        </div>
