...
<h3 class="blue">Last Active Users In 10 Minutes</h3>
...
<?php foreach($results as $user): ?>
    <li class="profile-details">
        ...
        <div class="clear"></div>
        <strong>Profile Status</strong>: <?= $user->membership->type; ?> - <strong>Credits</strong>: <?= $user->credits ?> - <strong>Last Activity</strong>: <?= date("F j, Y, g:i a", $user->last_seen); ?>
    </li>
<?php endforeach; ?>
</ul>
<?php endif; ?>