...
<h1><?= __('Login to your Flirtbucks Account'); ?></h1>
<h3 class="blue">Account Information</h3>
<?php
echo Form::open($_SERVER['REQUEST_URI'], array('id' => 'register'));
?>
<fieldset>
<?php
...
echo '<br /><span style="padding-left: 165px;">' . HTML::anchor('/account/resetpass', 'Forgot Password?') . '</span>';
...
echo Form::close();
?>
<h1><?= __('Create your Flirtbucks Account'); ?></h1>
<h3 style="margin-left: 120px;"><?= HTML::anchor('/account/create', 'Sign Up Now!'); ?></h3><br /><br />
</div>