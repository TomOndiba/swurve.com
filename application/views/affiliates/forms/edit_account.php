...
<h1 style="font-size: 26px;">Edit Affiliate Account</h1>
        ...
        <table align="left" cellspacing="1" cellpadding="0" id="account-info2" style="margin-bottom: 5px; display: inline; vertical-align: top; margin-top: 1px;">
            ...
            <tr>    
                <td class="table-data" colspan="2" style="padding-left: 100px;">
                    <?= Form::radio('program', (isset($post['program']) AND $post['program'] != 'Revshare') ? $post['program'] : 'PPS', (isset($post['program']) AND $post['program'] != 'Revshare') ? TRUE : FALSE, array()); ?> Pay Per Sale <?= Form::radio('program', 'Revshare', (isset($post['program']) AND $post['program'] == 'Revshare') ? TRUE : FALSE, array('style' => 'margin-left: 30px;')); ?> Rev-Share
...
<center>
    <?= Form::checkbox('mailstatus', '0', ($post['mailstatus']) ? FALSE : TRUE, array('id' => 'tou')) . 'I would like to recieve email notifications of affiliate promos and news.'; ?><br /><br />
