...
<script type="text/javascript" src="/assets/js/jquery-migrate.min.js?_=1408648340"></script>
<!--[if IE]>
...
<p>
    ...
    <select name="site" id="site-select">
        ...
        <option <?php if (isset($post['site']) AND $post['site'] == 'Swurve') echo 'selected="selected"'; ?> value="Swurve">Swurve</option>
        <option <?php if (isset($post['site']) AND $post['site'] == 'Kruze') echo 'selected="selected"'; ?> value="Kruze">Kruze</option>
        <option <?php if (isset($post['site']) AND $post['site'] == 'Russian Desire') echo 'selected="selected"'; ?> value="Russian Desire">Russian Desire</option>
    </select><br /><br />
