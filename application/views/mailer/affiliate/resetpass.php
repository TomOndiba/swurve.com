            ...
            <table style="font-family: verdana; font-size: 12px; background-color: #F2F5F8; border: 2px solid #95999C; text-align: left;" cellspacing="0" cellpadding="0">
                <tr>
                    <td style="padding: 20px;">
                        ...
                        <p>A request to reset the password of the account <?= $to->email; ?> was issued online from the IP <?= $_SERVER['REMOTE_ADDR']; ?></p>
                        
                        <p><h2 style="font-size: 16px;"><?= HTML::anchor(URL::base(TRUE, 'https') . 'affiliates/account/resetpass/' . strtolower($to->email) . '/' . $to->password, 'Click here to confirm this request'); ?></h2></p>
