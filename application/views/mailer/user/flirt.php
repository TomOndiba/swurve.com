...
<table style="font-family: verdana; font-size: 9px; width: 580px; text-align: center;" cellspacing="0" cellpadding="0">
    <tr>
        <td>
            To ensure you never miss a flirt, please add support@swurve.com to your address book / contacts.<br /><br />
            ...
            <table style="font-family: verdana; font-size: 12px; background-color: #F2F5F8; border: 2px solid #95999C; text-align: left;" cellspacing="0" cellpadding="0">
                <tr>
                    <td style="padding: 20px;">
                        <h1 style="font-size: 16px;">You've received a Flirt <?= $to->username; ?></h1>
                        ...
                        <p>
                            <table style="font-family: verdana; font-size: 12px;">
                                <tr>
                                    ...
                                    <td style="padding-left: 15;" valign="middle"><?= $from->username; ?> has sent you a flirt on Swurve! Log in now to view <?= ($from->gender == 'Male') ? 'his' : 'her'; ?> profile, read what <?= ($from->gender == 'Male') ? 'he' : 'she'; ?> has to say, and most importantly- Flirt back!<br /><br />
