...
Someone Likes You, <?= $to->username; ?> 

<?= $from->username; ?> has added you to their favorite profiles on Swurve! Log in now to view <?= ($from->gender == 'Male') ? 'his' : 'her'; ?> profile and if you like what you see add <?= ($from->gender == 'Male') ? 'him' : 'her'; ?> back to make a match!

Visit the following to access your playbook now - <?= URL::base(TRUE, 'https') . 'auto/login/playbook?' . strtolower($to->username) . '/' . $to->password; ?> 
