            ...
            <table style="font-family: verdana; font-size: 12px; background-color: #F2F5F8; border: 2px solid #95999C; text-align: left;" cellspacing="0" cellpadding="0">
                <tr>
                    <td style="padding: 20px;">
                        <h1 style="font-size: 16px;">Someone Likes You, <?= $to->username; ?></h1>
                        ...
                        <p>
                            <table style="font-family: verdana; font-size: 12px;">
                                <tr>
                                    ...
                                    <td style="padding-left: 15;" valign="middle"><?= $from->username; ?> has added you to their favorite profiles on Swurve! Log in now to view <?= ($from->gender == 'Male') ? 'his' : 'her'; ?> profile and if you like what you see add <?= ($from->gender == 'Male') ? 'him' : 'her'; ?> back to make a match!<br /><br />
