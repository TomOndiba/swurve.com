...
<table style="font-family: verdana; font-size: 9px; width: 580px; text-align: center;" cellspacing="0" cellpadding="0">
    <tr>
        <td>
            To ensure you never miss a match notification, please add support@swurve.com to your address book / contacts.<br /><br />
            ...
            <table style="font-family: verdana; font-size: 12px; background-color: #F2F5F8; border: 2px solid #95999C; text-align: left;" cellspacing="0" cellpadding="0">
                <tr>
                    <td style="padding: 20px;">
                        <h1 style="font-size: 16px;">You've Made a Connection, <?= $to->username; ?></h1>
                        ...
                        <p>
                            <table style="font-family: verdana; font-size: 12px;">
                                <tr>
                                    ...
                                    <td style="padding-left: 15;" valign="middle">Congratulations! <?= $from->username; ?> has confirmed you as a match on Swurve! Remember, matches have special access priviledges to one another on the service.<br /><br />Don't let <?= $from->username; ?> get away- Log in now to see what's happening with <?= $from->username; ?>, send <?= ($from->gender == 'Male') ? 'him' : 'her'; ?> an email, and most importantly- build off this connection!<br /><br />
                                    <center><h2 style="font-size: 16px;"><?= HTML::anchor(URL::base(TRUE, 'https') . 'auto/login/playbook?' . strtolower($to->username) . '/' . $to->password, 'Click here to access your playbook now'); ?></h2></center></td>
                                </tr>
                            </table>
                        </p>
