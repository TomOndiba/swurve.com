...
class Model_Camgirl extends ORM 
{
    protected $_belongs_to = array('swurve' => array('model'  => 'user'), 'country' => array(), 'region' => array(), 'city' => array());
    ...
    protected $_callbacks = array('email' => array('unique_email'), 'birthdate' => array('valid_date'));
    ...
    public function check()
    {
        ...
        if (isset($this->payment_method) AND $this->payment_method == 'Paypal')
        {
            $this->_labels += array('payment_method_account' => 'Paypal Email');
