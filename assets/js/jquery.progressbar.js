	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				boxImage		: '/assets/img/progressbar.gif',						// boxImage : image around the progress bar
				barImage		: {
									0:	'/assets/img/progressbg_red.gif',
									30: '/assets/img/progressbg_orange.gif',
									70: '/assets/img/progressbg_green.gif'
								},
